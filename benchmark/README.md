...
### Dataset Setup
The benchmark expects the LIMIT dataset to be locally available in the following structure:
```
...
| `--cache-dir` | Model cache directory | `./models` |
...
├── limit_dataset/                   # Local LIMIT dataset
